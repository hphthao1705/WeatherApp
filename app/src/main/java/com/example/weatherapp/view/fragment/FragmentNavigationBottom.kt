...
class FragmentNavigationBottom(val list_city: ArrayList<Data>, val list_room: ArrayList<Search>, val state: State) : Fragment() {
    ...
    private fun clickOnNavigation() {
        ...
        binding.bottomNavigation.setOnNavigationItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.city -> replaceFragment(FragmentCity(list_city, list_room))
            }
            true
        }
    }
...
//        val activity: MainActivity? = activity as MainActivity
        when(state.state)
        {
            ...
            "Cities" -> replaceFragment(FragmentCity(list_city, list_room)) //replaceFragment(FragmentFavouriteCity(listRoom.isNotEmpty(), listRoom))
